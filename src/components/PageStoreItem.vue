    ...
    <template v-else>
      ...
      <div class="section details">
        <transition name="fade">
          <BaseLoading v-if="detailsLoading" key="loading" class="overlay"/>
          <div v-else-if="details" key="content" class="details-content">
            <BaseImage ref="image" class="item-image" :src="details.img"/>
            <div class="details-toolbar">
              <StoreItemInfos :item="details"/>
              <BaseButton icon="add" @click="addToCart">Add to cart</BaseButton>
            </div>
          </div>
        </transition>
      </div>
      ...
      <div class="section comments">
        ...
        <transition name="fade">
          <BaseLoading v-if="commentsLoading" key="loading" class="overlay"/>
          <div v-else key="content" class="comments-content">
